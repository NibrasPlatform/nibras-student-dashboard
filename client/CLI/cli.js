...
function loadProgress() {
    try {
        var stored = JSON.parse(localStorage.getItem('nibras_cli_progress') || '[]');
...
function switchOs(os, btn) {
    ...
    btn.classList.add('active');
    document.querySelectorAll('.os-content').forEach(function (c) { c.style.display = 'none'; });
    document.querySelectorAll('.os-content.' + os).forEach(function (c) { c.style.display = ''; });
}

window.NibrasReact.run(() => {
    ...
    async function loadCourses() {
        ...
        try {
            ...
            courses.forEach(function (c) {
                ...
                option.value = id;
                option.textContent = (c.code ? c.code + ' - ' : '') + (c.title || c.name || 'Untitled');
    ...
    function init() {
        ...
        document.getElementById('create-section-form').addEventListener('submit', async function (e) {
            ...
            try {
                var res = await apiCall('/admin/courses/' + encodeURIComponent(courseId) + '/sections', {
                    method: 'POST',
                    body: body,
                });
                ...
                redirectWithToast(
                    '../Sections/section-detail.html?courseId=' + encodeURIComponent(courseId) + '&sectionId=' + encodeURIComponent(newSectionId),
                ...
                alert('Failed to create section: ' + (error.message || 'Unknown error'));
            }
        });
    }
